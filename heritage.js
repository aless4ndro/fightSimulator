class Personnage {
  ...
  class Guerrier extends Personnage {
      constructor(pseudo) {
      super(pseudo, "gurrrier", 350, 50);
      }
  
      attaquer(personnage) {
          personnage.sante -= this.attaque;
          console.log(this.pseudo + ' attaque ' + personnage.pseudo + ' avec son épeé (' + this.attaque + ' dégâts)');
          this.evoluer();
          this.verifierSante();
      }
      ...
      coupSpecial(personnage) {
          personnage.sante -= this.attaque * 5;
          console.log(this.pseudo + ' attaque avec son coup spécial puissance hache de guerre ' + personnage.pseudo + ' (' + this.attaque * 5 + ' dégâts)');
          this.evoluer();
          personnage.verifierSante();
  }
  }
